...
const mockPropertiesResponse = Array(10).fill(mockProperty);

getAllProperties.mockImplementation(() => {
    return mockPropertiesResponse;
});

describe('PropertyListing', () => {
    it('should render the correct number of property cards', async () => {
        ...
        expect(propertyCards).toHaveLength(mockPropertiesResponse.length);
    });
});
